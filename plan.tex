...
\begin{table}[t]
    \begin{tabularx}{\textwidth}{c | X | X | X}
        ...
        \\ \hline
        % Video & 
        % \parbox[c]{\hsize}{\includegraphics[width=1.2in]{figures/obvious/facebook_post_copyright}} & 
        % \parbox[c]{\hsize}{\includegraphics[width=1.2in]{figures/ambiguous/asiansdirtymugglesvideo}} &
        % \parbox[c]{\hsize}{\includegraphics[width=1.2in]{figures/obvious/youtubemisinformationobvious}} 
        % \\ \hline
    Text & 
